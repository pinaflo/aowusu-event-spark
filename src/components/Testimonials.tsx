...
const testimonials = [
  {
    ...
    event: "Wedding",
    rating: 5,
    text: "AOWUSU made our dream wedding come true! Every detail was perfect, from the venue coordination to the last dance. They truly understood our vision.",
    image: "👰"
  },
  {
    name: "Marcus Chen",
  ...
  },
  {
    ...
    rating: 5,
    text: "My 40th birthday party was absolutely magical! AOWUSU took care of everything while I enjoyed celebrating with my loved ones. Highly recommend!",
    image: "🎉"
  },
  {
    name: "David Thompson",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            have to say about their AOWUSU experience.
          </p>
        </div>
